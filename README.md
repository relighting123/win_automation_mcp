...
│  ┌─────────────────────────────────────────────────────┐   │
│  │                    Tools Layer                       │   │
│  │  app_tool.py | app_ui_tool.py | source_open_tool.py  │   │
│  │  color_click_tool.py                                 │   │
│  │  (업무 의미 단위 인터페이스)                          │   │
│  └─────────────────────────────────────────────────────┘   │
│                              │                              │
...
│  ┌─────────────────────────────────────────────────────┐   │
│  │                   Actions Layer                      │   │
│  │  app_ui_action.py | source_open_action.py           │   │
│  │  (업무 로직, 조건 분기, 재시도)                       │   │
│  └─────────────────────────────────────────────────────┘   │
│                              │                              │
│                              ▼                              │
...
│
├── actions/
│   ├── app_ui_action.py    # active window 기반 OCR/UIA/좌표 액션
│   └── source_open_action.py
│
├── tools/
│   ├── app_tool.py         # 애플리케이션 관리 도구
│   ├── app_ui_tool.py      # 화면 분석/키워드/아이콘/단축키 도구
...
- **원칙**:
  - 업무 의미 단위로만 정의 (analyze_app_screen, click_app_keyword 등)
  - Actions 계층만 호출
  - pywinauto 직접 호출 금지
...
- `check_app_screen_state`: active window 기준 화면 상태 플래그 확인
