...
def register_source_code_tools(*args, **kwargs):
    from .source_code_tool import register_source_code_tools as _register_source_code_tools

    return _register_source_code_tools(*args, **kwargs)
